...
public class MainActivity extends Activity {
    ...
    private void log(String m){ runOnUiThread(()->{ String old=logView.getText().toString(); if(old.length()>18000) old=old.substring(0,15000); String time=new java.text.SimpleDateFormat("HH:mm:ss.SSS",Locale.US).format(new java.util.Date()); logView.setText("["+time+"] "+m+"\n"+old); }); }
