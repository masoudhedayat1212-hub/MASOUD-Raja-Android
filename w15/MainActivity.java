...
public class MainActivity extends Activity {
    ...
    private class JsBridge {
        ...
        @JavascriptInterface public void loginClicked(){ runOnUiThread(()->{ loginInProgress=false; loggedIn=true; loginRetryCount=0; log("دکمه ورود زده شد؛ منتظر تکمیل ورود..."); handler.postDelayed(()->advanceAutomation(),2600); }); }
